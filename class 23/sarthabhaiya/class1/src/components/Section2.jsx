    ...
    <div className='flex px-10 mt-8'>
        <div id="right " className='w-[72%] '>
            <h1 className='text-8xl p-8 '>
                                ...
                                hearts
                                <svg  class="lg:w-10 mei" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 52 52" fill="none" preserveAspectRatio="xMidYMid meet" aria-hidden="true" role="img">
