...
//    console.log(randomcolor()); generate random color for each user
    let card = `    <div class="box">
                        <div id="top">
                            <div id="available"><h3>${user.available ? "Available" : ''}</h3></div>
                            <h3>${user.rate}/hr</h3>
                        </div>
                        <img src="${user.profilePhoto}" alt="">
                        <h2>${user.fullName}</h2>
                        <h4>${user.designation}</h4>
                        <h3 style="color: ${randomcolor()};">${user.company}</h3> 
                        <div id="skills">
                            <div class="skill" id="skill1"><h5>${user.skills[0]}</h5></div>
                            <div class="skill" id="skill2"><h5>${user.skills[1]}</h5></div>
                            <div class="skill" id="skill3"><h5>${user.skills[2]}</h5></div>
                            <div id="moreSkills"><h5>+${user.skills.length - 3}</h5></div>
