  ...
  return (
    <div className='w-[100%]  flex flex-col justify-center items-center'>
        ...
        <div className=' w-[90%] h-[100%] group  my-10 relative '>
            ...
            <img className='w-[40%] aspect-square rounded-[5rem] transition-all duration-300 absolute top-[50%] left-[50%] -translate-y-2/4 -translate-x-2/4 opacity-0 group-hover:opacity-100'
